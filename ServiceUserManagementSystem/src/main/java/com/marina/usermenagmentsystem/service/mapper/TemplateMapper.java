...
//    })
     TemplateDTO toDtoModel(Template template);

    List<TemplateDTO> toDtoModel(List<Template> templates);
    List<Template> toDataModel(List<TemplateDTO> templates);
//    @Mappings({
...
//    })
    Template toDataModel(TemplateDTO templateField);
}
